...
@section('content')
    <div class="row">
        <form class="form-horizontal" role="form" method="GET" action="{{ url('/search_crime_records_delete')}}">
            <div class="form-group">
                <div class="col-sm-7 col-sm-offset-2">
                    <input type="search" class="form-control" id="search" name="keyword" placeholder="search record to delete" style="height:30px; ">
                </div>
                <div class="col-sm-2 ">
        ...
        <div class="col-md-10 col-md-offset-1">
            <table class="table table-hover" id="tweets_table">
                ...
                @foreach($records as $record)
                    <tr id="{{$record->id}}">
                        <td><a class="btn btn-danger" href="{{url('/delete')}}/{{$record->id}}">Delete</a></td>
