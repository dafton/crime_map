                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/edit/'.$record->id)}}">
                                    {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('crime_type') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="crime_type">
                                        @foreach($markers as $marker)
                                            ...
                                            <option {{ $marker->id == $record->marker_id ? 'selected' : '' }} value="{{$marker->crime_type}}">
                                                {{$marker->crime_type}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group {{ $errors->has('time_committed') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group {{ $errors->has('area_committed') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="area_committed" name="area_committed" value="{{$record->area_committed}}" readonly>
                                    ...
                                    <div class="form-group {{ $errors->has('latitude') ? ' has-error' : '' }}">
                                        ...
                                        <input type="string" class="form-control" id="form-latitude" name="latitude" value="{{$record->latitude}}" readonly>
                                    ...
                                    <div class="form-group {{ $errors->has('longitude') ? ' has-error' : '' }}">
                                        ...
                                        <input type="string" class="form-control" id="form-longitude" name="longitude" value="{{$record->longitude}}" readonly>
                                ...
                                <div class="form-group">
                                    <div id="collapseExample" class="collapse">
                                        ...
                                        <input type="string" class="form-control" id="offender_name" name="offender_name"  value="{{$record->offender_name}}">
                                        <label for="offender_id">Offender ID</label>
                                        <input type="string" class="form-control" id="offender_id" name="offender_id" value="{{$record->offender_id}}">
                                    </div>
                                </div>
